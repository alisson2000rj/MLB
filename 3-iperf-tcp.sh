...
#
#
py h1.cmd('python 3-iperf.py h1 10.0.0.5 1 tcp &')
py h2.cmd('python 3-iperf.py h2 10.0.0.6 2 tcp &')
py h3.cmd('python 3-iperf.py h3 10.0.0.7 3 tcp &')
py h4.cmd('python 3-iperf.py h4 10.0.0.8 4 tcp &')
